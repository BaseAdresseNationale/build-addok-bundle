...
S3_PATH_INPUT_FILE_PATH=$S3_ADDOK_PATH/$S3_INPUT_FILE_NAME
LOCAL_INPUT_FILE_PATH=data/$S3_INPUT_FILE_NAME

S3_OUTPUT_FILE_PATH=$S3_ADDOK_PATH/$S3_OUTPUT_FILE_NAME
LOCAL_OUTPUT_FILE_PATH=dist/$S3_OUTPUT_FILE_NAME
